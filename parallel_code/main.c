...
int main(int argc, char *argv[])
{
  ...
  */
  ...
  MPI_Gatherv((&u)->image_data[start], counts[my_rank]-1, MPI_FLOAT, (&whole_image)->image_data[0], counts, displs, MPI_FLOAT, 0, MPI_COMM_WORLD);
  printf("After gather..\n");
  if (my_rank==0) {
